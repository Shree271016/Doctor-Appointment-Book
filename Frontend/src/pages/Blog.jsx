    ...
    return (
        <div className="container mx-auto p-6 pt-32">
            ...
            <div className="bg-blue-50 p-6 rounded-lg mb-8">
                ...
                <p className="text-center text-lg text-gray-700 hover:animate-hover-pulse">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-6 rounded-xl shadow-md">
                    <h2 className="text-2xl font-semibold mb-4 text-blue-900 animate-slide-in">Patient-Centric Features</h2>


                    <ul className="list-disc list-inside space-y-3 text-gray-700 hover:animate-hover-pulse">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-4">
                <div className="bg-white p-6 rounded-xl shadow-md">
                    ...
                    <ul className="list-decimal list-inside text-gray-700 mb-4 hover:animate-hover-pulse">
                    ...
                    <div className="max-w-md">
                        ...
                        <div className="flex flex-col space-y-3">
                            <a href="https://www.shreekrishnapudasaini.com.np/"
                                ...
                                className="hover:animate-hover-pulse bg-[rgb(0,126,105)] text-white px-4 py-2 rounded-lg text-center hover:bg-white hover:text-[rgb(0,126,105)] hover:border-[rgb(0,126,105)] hover:border transition">
                                View My Portfolio
                            </a>
                            <a
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="p-6 bg-white rounded-xl shadow-md">
                    ...
                    <ul className="space-y-3 text-gray-700 hover:animate-hover-pulse">
            ...
            <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                <div className="p-4 bg-white rounded-lg shadow hover:animate-hover-pulse">
            ...
            <div className="mt-12 bg-gradient-to-r from-blue-50 to-purple-50 p-8 rounded-xl border border-blue-100 ">
                <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                    <div>
                        ...
                        <h3 className="text-xl font-bold text-gray-800 mb-2 hover:animate-hover-pulse">Need a Custom Healthcare Solution?</h3>
                        ...
                        <div className="flex space-x-3">
                            <a href="https://www.shreekrishnapudasaini.com.np/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="bg-[rgb(0,126,105)] text-white px-4 py-2 rounded-lg hover:bg-[rgb(0,126,105)] transition hover:animate-hover-pulse" >
