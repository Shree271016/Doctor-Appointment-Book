...
const Blog = () => {
    return (
        <div className="container mx-auto p-6 pt-32">
            <AnimateOnScroll delay={0.1} yOffset={60} >

                <h1 className="text-3xl font-bold text-center mb-6">Revolutionizing Healthcare with Our Doctor Appointment Booking App</h1>
            </AnimateOnScroll>
